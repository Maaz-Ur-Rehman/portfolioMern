...
function ImageSliderProperty(props) {
  ...
  return (
    <div className="results">
      ...
      <div className="info">
        <h2 className={"flat-info-box-title" + (props.textShadow ? " text-shadow-s" : "")} style={{"color": props.color}}>{props.title}</h2>
...
export default ImageSliderProperty;
